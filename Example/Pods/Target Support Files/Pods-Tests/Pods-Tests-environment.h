...
// podtest2
#define COCOAPODS_POD_AVAILABLE_podtest2
#define COCOAPODS_VERSION_MAJOR_podtest2 0
#define COCOAPODS_VERSION_MINOR_podtest2 1
#define COCOAPODS_VERSION_PATCH_podtest2 0
